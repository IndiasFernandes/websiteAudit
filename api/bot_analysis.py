...
def generate_analysis_prompt(html_content):
    ...
    prompts = [
        "You are a marketer specialized in landing page conversion optimization. Analyze landing page in html, provide an answer with a maximum of 950 bytes,  and grade how well it is designed for conversion optimization. Give it a score from 1 to 10, with 1 being the lowest, and 10 being the highest grade. In your answer provide only a numeric score, without any text.",
        "You are a marketer specialized in landing page conversion optimization. Analyze landing page in html, provide an answer with a maximum of 950 bytes,  including spaces and detail how well the landing page uses CTA buttons. Focus on where the buttons are placed: is there a call-to-action button in the header and is there a main call to action above the fold. Furthermore, check if the landing page repeats call to action throughout the page, and if there are any secondary call to actions. At the end provide further recommendations about placement of call-to-action buttons.",
        "You are a marketer specialized in landing page conversion optimization. Analyze landing page in html, provide an answer with a maximum of 950 bytes,  including spaces and detail if the landing page is doing well in terms of clarity of call to actions. Focus on how instructive the call to actions are; can call to actions be interpreted only in one way or are they confusing; are call to actions using simple language that the user can easily understand? At the end provide further recommendations about clarity of call-to-actions buttons.",
        "You are a marketer specialized in landing page conversion optimization. Analyze landing page in html, provide an answer with a maximum of 950 bytes,  including spaces and detail how well the landing page is doing in terms of the headlines. Focus on how clear the headlines are, are they clearly communicating the purpose of the landing page, or are they confusing, to abstract or too difficult to understand. At the end provide further recommendations about focus of the headlines.",
        "You are a marketer specialized in landing page conversion optimization. Analyze landing page in html, provide an answer with a maximum of 950 bytes,  including spaces and detail how well the landing page is doing in terms of clarity of the messaging. Focus on: How well focused is the message of the page: is there a clear goal to the page and is the user guided to that goal in a simple and clear way? If there is an offer on the page, how well is it presented - is the messaging appealing, are the benefits clear and well presented, are the terms transparent? Is the message of the page cohesive, or are there any contradictory or opposing messages? Are there any signals of trust, such as customer reviews, testimonials, or clients lists? How is the readability of the text? At the end provide further recommendations about clarity of the messaging.",
        "You are a marketer specialized in landing page conversion optimization. Analyze landing page in html, provide an answer with a maximum of 950 bytes,  including spaces and detail how well the landing page is doing in terms of clarity of forms. Is there a form on the website; how well is it placed on the landing page; does the landing page provide alternative way of contact, for those who fail to fill the form; is the form short enough; if the form is divided into steps, does it use the progress bar, to signal the length of the form. At the end, provide further recommendations regarding the form."
    ]
    return prompts
